...
public class JUnit5HamcrestListTest {
    ...
    public void testListWithHamcrest() {
        ...
        assertThat("리스트에 순서에 맞게 객체를 포함하고 있는지 검증", values, contains("Oliver", "Jack", "Harry"));
        assertThat("리스트에 순서에 상관없이 객체를 포함하고 있는지 검증", values, containsInAnyOrder("Jack", "Harry", "Oliver"));
    }
}
